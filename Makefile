...
CXXFLAGS	:=	$(CFLAGS) -fno-rtti -fno-exceptions -Wno-narrowing -Wno-reorder
...
#---------------------------------------------------------------------------------
LIBS	:= -lmm -ltonc -lgba-sprite-engine
...
# include and lib
#---------------------------------------------------------------------------------
LIBDIRS	:=	$(CURDIR)/libtonc $(LIBGBA) $(CURDIR)/gba-sprite-engine
