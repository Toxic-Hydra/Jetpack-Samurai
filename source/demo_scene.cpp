...
void DemoScene::tick(u16 keys)
{
    ...
    else
    {
        ...
        if (playerSprite->collidesWith(*enemy->getSprite()))
        {
            ...
            //     // if ArcherEnemy is coming in from the player's left-side
            ...
            //     }
            //     // If ArcherEnemy is coming in from the player's right-side
